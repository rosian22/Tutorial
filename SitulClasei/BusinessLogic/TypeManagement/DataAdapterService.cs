...
using BusinessLogic.TypeManagementS;

[assembly: InternalsVisibleTo("SitulClasei.BusinessLogicTests")]

namespace SitulClasei.BusinessLogic.TypeManagement
{
    internal static class DataAdapterService
    {
        ...
        private static void InitializeMapper()
        {
            ...
            var mapperConfiguration = new MapperConfiguration(config =>
            {
                ...
                DasConfigurator.ConfigureStudents(config);
                DasConfigurator.ConfigureSubjects(config);
