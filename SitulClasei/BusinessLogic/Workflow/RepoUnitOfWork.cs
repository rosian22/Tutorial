...
using SitulClasei.BusinessLogic.Workflow.Enum;
...
namespace SitulClasei.BusinessLogic.Workflow
{
    internal class RepoUnitOfWork : IUnitOfWork
    {
        ...
        private static void InitializeRepositoriesIoc()
        {
            ...
            {
                {typeof (AspNetUserRepository), () => new AspNetUserRepository()},
                {typeof (StudentRepository), () => new StudentRepository() },
                {typeof (global::DataLayer.GroupRepository), () => new global::DataLayer.GroupRepository()},
                {typeof (global::DataLayer.SubjectRepository), () => new global::DataLayer.SubjectRepository() }
            };
        }
