...
using SitulClasei.DataLayer.Extensions;
using SitulClasei.DataLayer.Interfaces;
using ClassLibrary3;

namespace SitulClasei.DataLayer.Repositories
{
        ...
        where T : class, IDataAccessObject, new()
    {
        ...
        public override sealed ClasaDbEntities1 Context
        {
